...
import { Search, SlidersHorizontal, Star, Clock, Users, PlayCircle, Lock, CheckCircle2, ArrowRight } from 'lucide-react';
                  ...
                  <Card className="card-premium card-premium-hover h-full overflow-hidden">
                    ...
                    <CardContent className="p-5">
                      ...
                      <div className="mt-3 flex items-center gap-4 text-xs text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1"><Users className="h-3.5 w-3.5" /> {c.students.toLocaleString('en-IN')}</span>
                      </div>
