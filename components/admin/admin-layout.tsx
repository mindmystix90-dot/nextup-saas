    ...
    <div className="flex h-full flex-col">
      <Link href={home} className="flex items-center gap-2.5 px-5 h-16 shrink-0 border-b border-border">
        ...
        <div className="leading-tight">
          <p className="font-display text-lg font-bold tracking-tight">NextUp</p>
      ...
      <div className="border-t border-border p-3">
        <Link
          href="/dashboard"
          className="mb-2 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        >
          <ShieldCheck className="h-4 w-4" /> Back to user dashboard
        </Link>
        <button
          onClick={logout}
